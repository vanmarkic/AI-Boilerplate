...
echo ""
echo "Next steps:"
echo "  1. Ensure shared/openapi.yaml has the endpoints, then run: make generate"
echo "  2. Fill in the TODO markers with your domain model"
echo "  3. Create migration: cd backend && alembic revision --autogenerate -m 'add ${SNAKE}'"
