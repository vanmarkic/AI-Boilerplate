...
- **Rules:**
  ...
  - WebSocket broadcasts state changes to all connected participants. Events and decisions with non-empty `target_roles` are split-broadcast: sent only to matching roles + GMs.
- **API:**
