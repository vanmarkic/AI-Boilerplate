...
type Story = StoryObj<ContextPanelComponent & { objectives: string[]; rules: string[] }>;

export const Default: Story = {
  args: {
    title: 'Scenario Context',
    briefing: 'A humanitarian crisis has developed in the eastern region. Displaced populations are moving westward and require immediate assistance. Local infrastructure is severely damaged.',
    objectives: [
...
export const BriefingOnly: Story = {
  args: {
    ...
    briefing: 'Satellite imagery confirms increased activity at the northern checkpoint. Weather conditions are expected to deteriorate over the next 24 hours with heavy rainfall and reduced visibility.',
    objectives: [],
    rules: [],
  },
};
