  ...
  render: () => (
    <div>
      <CollapsiblePanel open header="Getting Started">
        Welcome to the platform. This section covers the basics of setting up your account and
        navigating the dashboard.
      </CollapsiblePanel>
      <CollapsiblePanel header="Configuration">
        Customize your workspace by adjusting notification preferences, theme settings, and
        integration options.
      </CollapsiblePanel>
      <CollapsiblePanel header="Advanced Settings">
        Fine-tune performance, manage API keys, and configure deployment pipelines for your
        projects.
      </CollapsiblePanel>
    </div>
  ),
