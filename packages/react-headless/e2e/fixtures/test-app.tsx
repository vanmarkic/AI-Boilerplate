...
export function TestApp() {
  ...
  switch (hash) {
    ...
    case 'dialog-nested':
      return <DialogNested />;
    case 'dialog-force-mount':
      return <DialogForceMount />;
    case 'tabs-auto':
      return <TabsAuto />;
    case 'tabs-manual':
      return <TabsManual />;
    case 'tabs-disabled':
      return <TabsDisabled />;
    case 'collapsible-basic':
      return <CollapsibleBasic />;
    case 'collapsible-disabled':
      return <CollapsibleDisabled />;
    case 'collapsible-force-mount':
      return <CollapsibleForceMount />;
    ...
    default:
      return <p>Navigate to a scenario via URL hash</p>;
  }
}
    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          style={{ position: 'fixed', top: '40%', left: '40%', background: 'white', padding: 24 }}
        >
  ...
  return (
    <Tabs.Root defaultValue="tab1">
      <Tabs.List>
        ...
        <Tabs.Trigger value="tab3" data-testid="trigger-3">
          Tab 3
        </Tabs.Trigger>
      </Tabs.List>
      <Tabs.Content value="tab1" data-testid="panel-1">
        Panel 1 content
      </Tabs.Content>
      <Tabs.Content value="tab2" data-testid="panel-2">
        Panel 2 content
      </Tabs.Content>
      <Tabs.Content value="tab3" data-testid="panel-3">
        Panel 3 content
      </Tabs.Content>
    </Tabs.Root>
  );
  ...
  return (
    <Tabs.Root defaultValue="tab1">
      <Tabs.List>
        ...
        <Tabs.Trigger value="tab2" data-testid="trigger-2" disabled>
          Tab 2 (disabled)
        </Tabs.Trigger>
        <Tabs.Trigger value="tab3" data-testid="trigger-3">
          Tab 3
...
function accordionKeyDown(e: React.KeyboardEvent<HTMLButtonElement>) {
  ...
  const triggers = Array.from(
    root.querySelectorAll<HTMLElement>('[data-accordion-trigger]:not([data-disabled])'),
  );
