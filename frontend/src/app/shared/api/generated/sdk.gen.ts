...
import type { HealthCheckApiHealthGetData, HealthCheckApiHealthGetResponse, CreateUserData, CreateUserResponse, CreateUserError, GetUserData, GetUserResponse, GetUserError } from './types.gen';
...
export const healthCheckApiHealthGet = <ThrowOnError extends boolean = false>(options?: Options<HealthCheckApiHealthGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<HealthCheckApiHealthGetResponse, unknown, ThrowOnError>({
        url: '/api/health',
        ...options
    });
};
